...
def pcl_repositories():
    maybe(
        ...
        url = "https://github.com/ian-sixwheel/rules_boost/archive/refs/heads/master.zip",
    ...
    maybe(
        ...
        strip_prefix = "pcl-master",
        urls = ["https://github.com/PointCloudLibrary/pcl/archive/refs/heads/master.zip"],
    )
